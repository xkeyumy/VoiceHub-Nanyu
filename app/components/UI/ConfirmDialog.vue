        ...
        >
          ...
          <div class="flex flex-col items-center p-8 text-center">
            ...
            <div class="flex gap-3 w-full">
              ...
              <button
                :class="[
                  'px-6 py-4 text-white text-xs font-black rounded-2xl shadow-lg transition-all active:scale-95 uppercase tracking-widest flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed',
                  showCancelButton ? 'flex-[2]' : 'w-full',
                  confirmBtnClasses
                ]"
